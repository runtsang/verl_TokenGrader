...
# Define Reward Shaping Params
# These can be tuned via command line overriding config.algorithm.reward_shaping.*
# For example: 
# algorithm.reward_shaping.window_size=10
# algorithm.reward_shaping.alpha_pos=0.1
# etc.

# We execute rs_main_reward_shaping.py
python3 rs_main_reward_shaping.py \
